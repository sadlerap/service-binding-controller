...
require (
	...
	github.com/vmware-tanzu/carvel-kapp-controller v0.38.4 // indirect
	...
	k8s.io/api v0.22.10 // indirect
	k8s.io/apimachinery v0.22.10 // indirect
	k8s.io/client-go v0.22.10 // indirect
